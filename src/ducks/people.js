...
export const FETCH_ALL_REQUEST = `${prefix}/FETCH_ALL_PEOPLE_REQUEST`;
export const FETCH_ALL_SUCCESS = `${prefix}/FETCH_ALL_PEOPLE_SUCCESS`;
export const FETCH_ALL_ERROR = `${prefix}/FETCH_ALL_PEOPLE_ERROR`;
